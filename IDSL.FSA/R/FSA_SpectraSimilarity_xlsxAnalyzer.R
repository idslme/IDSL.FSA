FSA_SpectraSimilarity_xlsxAnalyzer <- function(spreadsheet, checkDataImportExport = TRUE) {
  ...
  if (typeof(spreadsheet) == "list") {
    if (ncol(spreadsheet) >= 4) {
      ...
      print("The `SpectraSimilarity` spreadsheet tab was not produced properly!")
    }
    ...
    if (length(spreadsheet) == 1) {
      if (file.exists(spreadsheet)) {
        ...
        print("The `SpectraSimilarity` spreadsheet tab not found! It should be an Excel file with .xlsx extention!")
      }
    } else {
      print("The `SpectraSimilarity` spreadsheet tab was not produced properly!")
    }
  ...
  if (checkpoint_parameter) {
    ...
    if (checkDataImportExport) {
      ...
      if (length(number_processing_threads) == 0) {
        print("ERROR!!! Problem with SPEC0001! This parameter should be a positive integer!")
        checkpoint_parameter <- FALSE
      } else {
        if (number_processing_threads >= 1) {
          ...
          print("ERROR!!! Problem with SPEC0001! This parameter should be at least 1 !")
          checkpoint_parameter <- FALSE
        }
      }
      ##
      if (number_processing_threads > 1) {
        ...
        if (is.na(SPEC0002)) {
          print("ERROR!!! Problem with SPEC0002!")
          checkpoint_parameter <- FALSE
        } else {
    ...
    if (length(x0003) > 0) {
      ...
      if (allowedNominalMass == "1" | allowedNominalMass == "t" | allowedNominalMass == "true") {
        ...
        print("NOTICE: Nominal masses will be utilized for spectra matching!")
      } else {
    ...
    if (is.null(targetedPrecursorType)) {
      print("ERROR!!! Problem with SPEC0004!")
      checkpoint_parameter <- FALSE
    }
    ##
    ...
    if (length(spectralEntropyDeviationPrefiltering) == 0) {
      print("ERROR!!! Problem with SPEC0007! This parameter should be a positive number!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (length(noiseRemovalRatio) == 0) {
      print("ERROR!!! Problem with SPEC0008! This parameter should be a positive number between 0 - 100!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (length(percentage2basePeak4nSpectraMarkers) == 0) {
      print("ERROR!!! Problem with SPEC0009! This parameter should be a positive number between 0 - 100!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (length(minPercentageMatchedNspectraMarkers) == 0) {
      print("ERROR!!! Problem with SPEC0010! This parameter should be a positive number greater than 0 and less than 100!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (!allowedNominalMass) {
      ...
      if (length(roundingDigitPrefiltering) == 0) {
        print("ERROR!!! Problem with SPEC0011! This parameter should be either 0, 1 or 2!")
        checkpoint_parameter <- FALSE
      } else {
      ...
      if (length(massError) == 0) {
        print("ERROR!!! Problem with SPEC0012! This parameter should be a positive number!")
        checkpoint_parameter <- FALSE
      } else {
        if (massError <= 0) {
          print("ERROR!!! Problem with SPEC0012! This parameter should be greater than `0 Da`!")
          checkpoint_parameter <- FALSE
        }
      }
    }
    ...
    if (length(minIonRangeDifference) == 0) {
      print("ERROR!!! Problem with SPEC0014! This parameter should be >= 0!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (length(minMatchedNumPeaks) == 0) {
      print("ERROR!!! Problem with SPEC0015! This parameter should be a positive integer!")
      checkpoint_parameter <- FALSE
    } else {
      if (minMatchedNumPeaks >= 1) {
        ...
        print("ERROR!!! Problem with SPEC0015! This parameter should be at least 1 !")
        checkpoint_parameter <- FALSE
      }
    }
    ##
    ...
    if (length(minEntropySimilarity) == 0) {
      print("ERROR!!! Problem with SPEC0016! This parameter should be a positive number between 0 - 1!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (length(minCosineSimilarity) == 0) {
      print("ERROR!!! Problem with SPEC0017! This parameter should be a positive number between 0 - 1!")
      checkpoint_parameter <- FALSE
    } else {
    ...
    if (!allowedNominalMass) {
      ...
      if (length(maxNEME) == 0) {
        print("ERROR!!! Problem with SPEC0018! This parameter should be a positive number!")
        checkpoint_parameter <- FALSE
      } else {
        if (maxNEME < 0) {
          print("ERROR!!! Problem with SPEC0018! This parameter should be a positive number!")
    ...
    if (checkDataImportExport) {
      ...
      if (length(maxAllowedNumberHits) == 0) {
        print("ERROR!!! Problem with SPEC0019! This parameter should be a positive number!")
        checkpoint_parameter <- FALSE
      } else {
      ...
      if (maxAllowedNumberHits > 0) {
        ...
        if (is.na(SPEC0020)) {
          print("ERROR!!! Problem with SPEC0020!")
          checkpoint_parameter <- FALSE
        } else {
