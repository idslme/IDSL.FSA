xlsx2msp <- function(path = getwd(), xlsxFileName = "", number_processing_threads = 1) {
  ##
  ...
  ##
  FSA_logRecorder(paste0("`", xlsxFileName, "` was converted into .msp format and stored in the same folder!"))
  ##
  return()
}